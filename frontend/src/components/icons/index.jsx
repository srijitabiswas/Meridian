/**
 * Icon set — sourced 1:1 from the supplied SVGs-*.zip asset pack.
 * Original fixed #000000 fill/stroke values were swapped for `currentColor`
 * so every icon inherits color from its parent and can be themed/animated
 * with plain CSS (color, opacity, transform) — no extra props needed.
 *
 * Where an icon ships in both outline + solid weight (link / chevron-up),
 * components are exported for both so callers can swap weight on
 * hover/active state for a subtle "icon animates" micro-interaction.
 */

export function IconArrowPath({ className = '' }) {
  return (
    <svg {...attrs(className)} viewBox="0 0 24 24" fill="none">
      <path
        stroke="currentColor"
        strokeLinecap="round"
...
export function IconChevronUpSolid({ className = '' }) {
  return (
    <svg {...attrs(className)} viewBox="0 0 24 24" fill="currentColor">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export function IconCube({ className = '' }) {
  return (
    <svg {...attrs(className)} viewBox="0 0 16 16" fill="currentColor">
...
export function IconLinkSolid({ className = '' }) {
  return (
    <svg {...attrs(className)} viewBox="0 0 24 24" fill="currentColor">
      <path
        fillRule="evenodd"
...
export function IconSearch({ className = '' }) {
  return (
    <svg {...attrs(className)} viewBox="0 0 20 20" fill="currentColor">
